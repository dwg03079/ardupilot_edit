...
bool ModeAutoD::does_auto_navigation() const
{
#if AP_SCRIPTING_ENABLED
...
bool ModeAutoD::does_auto_throttle() const
{
#if AP_SCRIPTING_ENABLED
    return (!plane.nav_scripting_active());
#endif
...
bool ModeAutoD::_pre_arm_checks(size_t buflen, char* buffer) const
{
#if HAL_QUADPLANE_ENABLED
