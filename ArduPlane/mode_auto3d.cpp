...
bool ModeAuto3D::does_auto_navigation() const
{
#if AP_SCRIPTING_ENABLED
...
bool ModeAuto3D::does_auto_throttle() const
{
#if AP_SCRIPTING_ENABLED
    return (!plane.nav_scripting_active());
#endif
