 ...
 */
/*
  driver for DLVR differential AOA sensor
...
AP_AOA_DLVR::AP_AOA_DLVR(AP_AOA &_frontend, uint8_t _instance, const float _range_inH2O) :
 ...
 */
AP_AOA_Backend *AP_AOA_DLVR::probe(AP_AOA &_frontend,
                                             uint8_t _instance,
                                             ...
                                             const float _range_inH2O)
{
    ...
    AP_AOA_DLVR *sensor = new AP_AOA_DLVR(_frontend, _instance, _range_inH2O);
    if (!sensor) {
        return nullptr;
    }
...
void AP_AOA_DLVR::setup()
{
    ...
    dev->register_periodic_callback(1000000UL/50U,
                                    FUNCTOR_BIND_MEMBER(&AP_AOA_DLVR::timer, void));
}

// probe and initialise the sensor
bool AP_AOA_DLVR::init()
{
...
bool AP_AOA_DLVR::get_differential_pressure(float &_pressure)
{
    WITH_SEMAPHORE(sem);
...
bool AP_AOA_DLVR::get_temperature(float &_temperature)
{
    WITH_SEMAPHORE(sem);
