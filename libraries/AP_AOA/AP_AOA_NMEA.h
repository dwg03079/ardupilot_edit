...
class AP_AOA_NMEA : public AP_AOA_Backend
{
public:
    AP_AOA_NMEA(AP_AOA &frontend, uint8_t _instance);

    // probe and initialise the sensor
    bool init(void) override;

    // this reads AOA directly
    bool has_AOA() override {return true;}

    // read the from the sensor
    bool get_AOA(float &AOA) override;
