...
/*
  backend driver for AOA sensor from www.qio-tek.com
  I2C ASP5033 sensor
 */
...
bool AP_AOA_ASP5033::init()
{
    ...
    for (uint8_t address : addresses) {
        ...
        dev->register_periodic_callback(1000000UL/80U,
                                        FUNCTOR_BIND_MEMBER(&AP_AOA_ASP5033::timer, void));
        return true;
    }
...
/*
  ...
  expected behaviour
*/
bool AP_AOA_ASP5033::confirm_sensor_id(void)
{
    uint8_t part_id;
...
bool AP_AOA_ASP5033::get_differential_pressure(float &pressure)
{
    WITH_SEMAPHORE(sem);
...
bool AP_AOA_ASP5033::get_temperature(float &temperature)
{
    WITH_SEMAPHORE(sem);
