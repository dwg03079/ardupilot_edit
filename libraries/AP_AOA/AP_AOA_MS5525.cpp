...
/*
  backend driver for AOA from a I2C MS5525D0 sensor
 */
...
AP_AOA_MS5525::AP_AOA_MS5525(AP_AOA &_frontend, uint8_t _instance, MS5525_ADDR address) :
...
bool AP_AOA_MS5525::init()
{
    ...
    dev->register_periodic_callback(1000000UL/80U,
                                    FUNCTOR_BIND_MEMBER(&AP_AOA_MS5525::timer, void));
    return true;
}
 ...
 */
uint16_t AP_AOA_MS5525::crc4_prom(void)
{
    return crc_crc4(prom);
}

bool AP_AOA_MS5525::read_prom(void)
{
...
/*
  read from the ADC
 */
int32_t AP_AOA_MS5525::read_adc()
{
    uint8_t val[3];
 ...
 */
void AP_AOA_MS5525::calculate(void)
{
...
bool AP_AOA_MS5525::get_differential_pressure(float &_pressure)
{
    WITH_SEMAPHORE(sem);
...
bool AP_AOA_MS5525::get_temperature(float &_temperature)
{
    WITH_SEMAPHORE(sem);
