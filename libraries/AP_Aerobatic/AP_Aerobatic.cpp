...
#include "AP_Aerobatic.h"

extern const AP_HAL::HAL& hal;

// table of user settable parameters
const AP_Param::GroupInfo AP_Aerobatic::var_info[] = {
    // @Param: PERIOD
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("PERIOD",    0, AP_Aerobatic, _L1_period, 17),
    ...
    // @Increment: 0.05
    // @User: Advanced
    AP_GROUPINFO("DAMPING",   1, AP_Aerobatic, _L1_damping, 0.75f),
    ...
    // @Increment: 0.01
    // @User: Advanced
    AP_GROUPINFO("XTRACK_I",   2, AP_Aerobatic, _L1_xtrack_i_gain, 0.02),
    ...
    // @Range: 0 89
    // @User: Advanced
    AP_GROUPINFO("LIM_BANK",   3, AP_Aerobatic, _loiter_bank_limit, 0.0f),
 ...
 */
float AP_Aerobatic::get_yaw() const
{
    if (_reverse) {
